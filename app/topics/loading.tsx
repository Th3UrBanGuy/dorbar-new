...
import { ArrowLeft, BookOpen, Heart, LogOut, ChevronLeft, Search, Bell, Activity, BookHeart } from "lucide-react";

export default function TopicReaderLoading() {
  return (
      ...
      <main className="flex-1 flex flex-col h-screen overflow-hidden bg-white md:rounded-l-[3rem] shadow-[-10px_0_30px_rgba(0,0,0,0.02)] relative">
        ...
        <div className="flex-1 overflow-y-auto px-4 sm:px-10 py-6 sm:py-10 pb-24 md:pb-10">
           <div className="max-w-4xl mx-auto flex flex-col gap-8">
              {/* Skeleton Search Bar */}
              <div className="sticky top-24 z-30 flex justify-end mb-2">
                 <div className="w-14 h-14 bg-slate-100 rounded-full animate-pulse shadow-sm"></div>
              </div>
